(ns sicp.lecture3a-3.core
  (:require [sicp.lecture3a-3.draw :as dynamic-draw]
            [sicp.lecture3a-3.setup :refer [HEIGHT WIDTH]]
            [sicp.lecture3a-3.setup :as dynamic-setup]
            [quil.core :as qc]))
